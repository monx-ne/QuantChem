...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, sharp corners, boxrule=0pt, breakable, borderline west={3pt}{0pt}{shadecolor}, frame hidden, interior hidden]}{\end{tcolorbox}}\fi
...
los orbitales atómicos de los átomos en una molécula, lo que representa
la distribución electrónica entre dos o más átomos. Estos se obtienen
mediante la adición o substracción de las funciones de onda que forman
la molécula. En este enfoque, se visualiza a los electrones llenando los
orbitale smoleculares uno por uno como sucede en los orbitales atómicos.
Esa teoría explica la formación de enlaces a través de la ocupación de
orbitales elecgrónicos caraterístico de la molécula (ver Moeller et al.
1980).

\hypertarget{estructura-de-bandas}{%
\section*{Estructura de bandas}\label{estructura-de-bandas}}
\addcontentsline{toc}{section}{Estructura de bandas}

La estructura de bandas representa los niveles de energía de un sólido,
y usualmente de utiliza para determinar si un material es conductor,
semiconductor o aislante (ver Fatima et al. 2023). Esta estructura de
bandas puede ser calculada utilizando diferentes aproximaciones, con sus
respectivos beneficios y desventajas, como lo es el método de DFT.
...
{\centering \includegraphics{./QuantChem_DFT_AnCarg_files/figure-pdf/fig-conv-hs-output-2.png}
...
{\centering \includegraphics{./QuantChem_DFT_AnCarg_files/figure-pdf/cell-10-output-2.png}
...
{\centering \includegraphics{./QuantChem_DFT_EstBandyHib_files/figure-pdf/cell-6-output-1.png}
...
\leavevmode\vadjust pre{\hypertarget{ref-FATIMA20233}{}}%
Fatima, Yangchao Liao, Sara A. Tolba, Luis Alberto Ruiz Pestana, and
Wenjie Xia. 2023. {``Chapter One - Electronic Structure and Density
Functional Theory.''} In \emph{Fundamentals of Multiscale Modeling of
Structural Materials}, edited by Wenjie Xia and Luis Alberto Ruiz
Pestana, 3--35. Elsevier.
...
\leavevmode\vadjust pre{\hypertarget{ref-MOELLER1980635}{}}%
Moeller, Therald, John C. Bailar, Jacob Kleinberg, Cyrus O. Guss, Mary
E. Castellion, and Clyde Metz. 1980. {``21 - THE COVALENT BOND
REEXAMINED.''} In \emph{Chemistry}, edited by Therald Moeller, John C.
Bailar, Jacob Kleinberg, Cyrus O. Guss, Mary E. Castellion, and Clyde
Metz, 635--58. Academic Press.
